...
### `apps/public-mobile/` → `docs/03-apps/public-mobile/`
- `IMPLEMENTATION_COMPLETE.md` → `docs/03-apps/public-mobile/10-implementation-complete.md`
- `PROMPT_TRIGGERS.md` → `docs/03-apps/public-mobile/04b-prompt-triggers.md`
- `USER_DATA_COLLECTION_PLAN.md` → `docs/03-apps/public-mobile/04c-user-data-collection-plan.md`
- `USER_DATA_COLLECTION_SUMMARY.md` → `docs/03-apps/public-mobile/04d-user-data-collection-summary.md`
- `USER_DATA_COLLECTION_FLOW.md` → `docs/03-apps/public-mobile/04e-user-data-collection-flow.md`
- `API_CODEBASE_ANALYSIS.md` → `docs/03-apps/public-mobile/05b-api-codebase-analysis.md`
- `API_COMPARISON_ANALYSIS.md` → `docs/03-apps/public-mobile/05c-api-comparison-analysis.md`
- `AUTH_INTEGRATION_SUMMARY.md` → `docs/03-apps/public-mobile/06a-auth-integration-summary.md`
- `CODEBASE_ANALYSIS.md` → `docs/03-apps/public-mobile/02b-codebase-analysis.md`
- `COMPREHENSIVE_CODEBASE_ANALYSIS.md` → `docs/03-apps/public-mobile/02c-comprehensive-codebase-analysis.md`
- `SESSION_PERSISTENCE_IMPROVEMENTS.md` → `docs/03-apps/public-mobile/11-session-persistence-improvements.md`

### `apps/backend/` → `docs/05-apps/backend/` and `docs/09-deployment/`
- `DEPLOYMENT_INSTRUCTIONS.md` → `docs/05-apps/backend/06a-deployment-instructions.md`
...
### `apps/admin-apps/public-web/` → `docs/06-apps/admin-apps/public-web/` and `docs/13-testing/`
- `CODEBASE_ANALYSIS.md` → `docs/06-apps/admin-apps/public-web/02a-codebase-analysis.md`
- `MERCHANTS_DUMMY_DATA.md` → `docs/06-apps/admin-apps/public-web/06-merchants-dummy-data.md`
- `MERCHANTS_MODULE.md` → `docs/06-apps/admin-apps/public-web/03a-merchants-module.md`
- `TEST_CREDENTIALS.md` → `docs/13-testing/03-test-credentials-admin.md`
- `TODO.md` → `docs/06-apps/admin-apps/public-web/07-todo.md`
- `db/DASHBOARD_ANALYTICS.md` → `docs/06-apps/admin-apps/public-web/05a-dashboard-analytics.md`
- `db/DATABASE_ANALYSIS.md` → `docs/06-apps/admin-apps/public-web/04a-database-analysis.md`

### `merchant-apps/public-mobile/` → `docs/04-merchant-apps/public-mobile/`
- `ZOEA_APP_ANALYSIS.md` → `docs/04-merchant-apps/public-mobile/04-zoea-app-analysis.md`

### `docs/` root → Appropriate subdirectories
- `PROJECT_STATUS.md` → `docs/01-project-overview/02a-project-status.md`
- `BACKEND_FILTERS_AND_SORTING.md` → `docs/05-apps/backend/07a-filters-and-sorting.md`
...
- `SEARCH_DATABASE_OPTIMIZATION.md` → `docs/03-apps/public-mobile/08c-search-database-optimization.md`
- `SEARCH_FEATURE_IMPLEMENTATION.md` → `docs/03-apps/public-mobile/08d-search-feature-implementation.md`
- `SEARCH_FEATURE_ANALYSIS.md` → `docs/03-apps/public-mobile/08e-search-feature-analysis.md`
...
- `AUTH_INTEGRATION_SUMMARY.md` → `docs/03-apps/public-mobile/06b-auth-integration-summary.md`
...
- `CODEBASE_ANALYSIS.md` → `docs/03-apps/public-mobile/02d-codebase-analysis.md`
- `COMPREHENSIVE_CODEBASE_ANALYSIS.md` → `docs/03-apps/public-mobile/02e-comprehensive-codebase-analysis.md`
...
- `SESSION_PERSISTENCE_IMPROVEMENTS.md` → `docs/03-apps/public-mobile/11a-session-persistence-improvements.md`
...
- `apps/public-mobile/README.md` - Mobile app README
- `apps/backend/README.md` - Backend README
- `apps/admin-apps/public-web/README.md` - Admin README
- `merchant-apps/public-mobile/README.md` - Merchant mobile README
- `apps/public-web/README.md` - Web README
...
- `apps/backend/src/migration/README.md` - Migration-specific README
- `apps/backend/src/migration/archive/README.md` - Archive README
