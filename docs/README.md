...
### [03. Mobile App (Consumer)](./03-apps/public-mobile/)
- [Overview](./03-apps/public-mobile/01-overview.md) - Mobile app overview and structure
- [Codebase Analysis](./03-apps/public-mobile/02-codebase-analysis.md) - Comprehensive codebase analysis
- [Features](./03-apps/public-mobile/03-features.md) - Mobile app features documentation
- [User Data Collection](./03-apps/public-mobile/04-user-data-collection.md) - UX-first data collection module
- [API Integration](./03-apps/public-mobile/05-api-integration.md) - API integration guide
- [Authentication](./03-apps/public-mobile/06-authentication.md) - Authentication implementation
- [Bookings](./03-apps/public-mobile/07-bookings.md) - Booking system implementation
- [Search](./03-apps/public-mobile/08-search.md) - Search feature implementation

### [04. Merchant Mobile App](./04-merchant-apps/public-mobile/)
- [Overview](./04-merchant-apps/public-mobile/01-overview.md) - Merchant mobile app overview
- [Codebase Analysis](./04-merchant-apps/public-mobile/02-codebase-analysis.md) - Merchant app analysis
- [Features](./04-merchant-apps/public-mobile/03-features.md) - Merchant app features

### [05. Backend API](./05-apps/backend/)
- [Overview](./05-apps/backend/01-overview.md) - Backend API overview
- [Codebase Analysis](./05-apps/backend/02-codebase-analysis.md) - Backend codebase analysis
- [API Reference](./05-apps/backend/03-api-reference.md) - Complete API endpoint reference
- [Database Schema](./05-apps/backend/04-database-schema.md) - Database schema documentation
- [Migration Guide](./05-apps/backend/05-migration-guide.md) - Database migration documentation
- [Deployment](./05-apps/backend/06-deployment.md) - Backend deployment guide
- [Filters and Sorting](./05-apps/backend/07-filters-and-sorting.md) - Filtering and sorting implementation

### [06. Admin Dashboard](./06-apps/admin-apps/public-web/)
- [Overview](./06-apps/admin-apps/public-web/01-overview.md) - Admin dashboard overview
- [Codebase Analysis](./06-apps/admin-apps/public-web/02-codebase-analysis.md) - Admin codebase analysis
- [Merchants Module](./06-apps/admin-apps/public-web/03-merchants-module.md) - Merchants management module
- [Database Analysis](./06-apps/admin-apps/public-web/04-database-analysis.md) - Admin database analysis
- [Dashboard Analytics](./06-apps/admin-apps/public-web/05-dashboard-analytics.md) - Analytics implementation

### [07. Web Applications](./07-apps/public-web/)
- [Consumer Web](./07-apps/public-web/01-consumer-web.md) - Consumer web app (planned)
- [Merchant Web](./07-apps/public-web/02-merchant-web.md) - Merchant web portal (planned)
...
- **[Mobile App Quick Start](../apps/public-mobile/QUICKSTART.md)** - Get mobile app running in 5 minutes
...
- **[Mobile Changelog](../apps/public-mobile/CHANGELOG.md)** - Mobile app version history
- **[Backend Changelog](../apps/backend/CHANGELOG.md)** - API version history
- **[Merchant Mobile Changelog](../merchant-apps/public-mobile/CHANGELOG.md)** - Merchant app changes
- **[Admin Changelog](../apps/admin-apps/public-web/CHANGELOG.md)** - Admin dashboard changes

### For Mobile Developers
- [Mobile App Overview](./03-apps/public-mobile/01-overview.md)
- [Mobile Features](./03-apps/public-mobile/03-features.md)
- [API Integration](./03-apps/public-mobile/05-api-integration.md)

### For Backend Developers
- [Backend Overview](./05-apps/backend/01-overview.md)
- [API Reference](./05-apps/backend/03-api-reference.md)
- [Database Schema](./05-apps/backend/04-database-schema.md)

### For Admin Developers
- [Admin Overview](./06-apps/admin-apps/public-web/01-overview.md)
- [Merchants Module](./06-apps/admin-apps/public-web/03-merchants-module.md)
...
├── apps/admin-apps/public-web/               # Admin dashboard (Next.js)
├── apps/public-web/                 # Consumer web app (Next.js - planned)
├── merchant-apps/public-web/        # Merchant web portal (Next.js - planned)
