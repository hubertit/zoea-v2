        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12">
          {loading ? (
              ...
              {listings
                ...
                .map((listing) => (
                  <ListingCard
                    ...
                    name={listing.name}
                    slug={listing.slug}
                    image={listing.images?.[0]?.media?.url || 'https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=800'}
            ...
            <div className="text-center py-16 sm:py-20 bg-gray-50 rounded-xl sm:rounded-2xl">
              <p className="text-[14px] sm:text-[15px] text-gray-600">No restaurants found</p>
            </div>
          )}
        </div>
      </main>
